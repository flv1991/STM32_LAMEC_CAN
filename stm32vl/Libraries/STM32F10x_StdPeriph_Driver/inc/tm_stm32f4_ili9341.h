...
#include "../inc/tm_stm32f4_fonts.h"
#include "stm32f10x_gpio.h"
...
typedef enum {
	TM_ILI9341_Image_Horizontal,  /*!< Portrait orientation mode 1 */
	TM_ILI9341_Image_Vertical  /*!< Portrait orientation mode 2 */
 ...
 * @retval None
 */
void drawbmp(const uint16_t *bmp ,TM_ILI9341_Image_t modo,uint16_t xinit, uint16_t yinit, uint16_t xend, uint16_t yend );
